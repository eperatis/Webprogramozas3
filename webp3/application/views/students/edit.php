...
<div class="row d-flex justify-content-center">
    <div class="text-center col-md-6">
        ...
        <?php echo form_input('firstName', set_value('firstName',"$students->firstName"),['class'=>'form-control' ],['id' => 'emp_firstName']); ?>
        <div class="alert-danger"><strong><?php echo form_error('firstName'); ?></strong></div>
        <br>
        <?php echo form_label('Vezeték név:','emp_lastName'); ?>
        <?php echo form_input('lastName', set_value('lastName',"$students->lastName"),['class'=>'form-control' ],['id' => 'emp_lastName']); ?>
        ...
        <?php 
            ...
            echo form_dropdown('osztaly', $options, "$students->osztaly",['class'=>'form-control'],['id' => 'emp_osztaly']);
        ?>
